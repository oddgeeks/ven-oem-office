...
import { OemVendoSerializeDto } from '../oem/main/oem-vendos/oem-vendo.dto/oem-vendo.serialize.dto';
...
import CreateOemVendosUsers from '../oem/seeds/create-oem-vendos-users.seed';
